...
export const semanticRules = {
    ...
    '15': {
        rule: 'ARG->num', semantic: (semantic) => {
            //ARG.atributos <- num.atributos
            semantic['ARG'] = semantic['NUM']
        }
    },
    '16': {
    ...
    '27': {
        rule: 'CP->ES CP', semantic: () => {
        }
    },
    '28': {
        rule: 'CP->CMD CP', semantic: () => {
        }
    },
    '29': {
        rule: 'CP->COND CP', semantic: () => {
        }
    },
    '30': {
        rule: 'CP->fimse', semantic: () => {
        }
    },
    '31': {
        rule: 'A->R A', semantic: () => {
    ...
    '34': {
        rule: 'CPR->ES CPR', semantic: () => {
        }
    },
    '35': {
        rule: 'CPR->CMD CPR', semantic: () => {
        }
    },
    '36': {
        rule: 'CPR->COND CPR', semantic: () => {
        }
    },
    '37': {
